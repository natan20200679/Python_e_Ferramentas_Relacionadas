# -*- coding: utf-8 -*-
"""DIO Bootcamp Santander Python 2025 (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/10VVND7Zj9a04d7z-O2zObVScjWbduGQS
...
# Obs.: Neste exemplo, a interrupção do laço não funcionará caso as linhas 5,6
# sejam trocadas de posição com as linhas 8,9.

"""# Desafio de Código (Validador de Formato de E-mails)"""

#Solução mais simplificada do que a presente no site.

email = input().strip()

if (email.count("@") == 1) and not (email.startswith("@")) and \
not (email.endswith("@")) and (" " not in email):
  print("E-mail válido")
else:
  print("E-mail inválido")

"""# Desafios de Projeto (Sistema Bancário com Funções)"""
